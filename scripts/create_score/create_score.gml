function create_score(offx = 0, offy = 0)
{
	...
	if(obj_zone.badnik_chain = 1){
		Object.image_index = 0;
		global.score += 100;
	}
	
	if(obj_zone.badnik_chain = 2){
		Object.image_index = 1;
		global.score += 200;
	}
	
	if(obj_zone.badnik_chain = 3){
		Object.image_index = 2;
		global.score += 500;
	}
	
	if(obj_zone.badnik_chain >= 4 && obj_zone.badnik_chain <= 15){
		Object.image_index = 3;
		global.score += 1000;
	}
	
	if(obj_zone.badnik_chain >= 16){
